...
namespace Studio.Utils.UI
{
    public static class UIExtensions
    {
        ...
        public static float NormalizeScrollDistance(this ScrollRect scrollRect, int axis, float distance)
        {
            ...
            var viewRect = viewport != default ? viewport : scrollRect.GetComponent<RectTransform>();
            var viewBounds = new Bounds(viewRect.rect.center, viewRect.rect.size);

            var content = scrollRect.content;
            var contentBounds = content != default ? content.TransformBoundsTo(viewRect) : new Bounds();
        ...
        public static void ScrollToCenter(this ScrollRect scrollRect, RectTransform target)
        {
            ...
            var view = scrollRect.viewport != default ? scrollRect.viewport : scrollRect.GetComponent<RectTransform>();
        ...
        /// <summary>
        /// Scrolls the target element to the vertical top of the scroll rect's viewport
        /// with an ease - outBack animation.
        /// Assumes the target element is part of the scroll rect's contents.
        /// </summary>
        /// <param name="scrollRect">Scroll rect to scroll</param>
        /// <param name="target">Element of the scroll rect's content to center vertically</param>
        ...
        /// <returns></returns>
        public static Sequence ScrollToTop(this ScrollRect scrollRect, RectTransform target, float duration = 0.5f)
        {
            // The scroll rect's view's space is used to calculate scroll position
            var view = scrollRect.viewport != default ? scrollRect.viewport : scrollRect.GetComponent<RectTransform>();
            ...
            var viewRect = view.rect;
            var elementBounds = target.TransformBoundsTo(view);
            var offset = viewRect.max.y - elementBounds.max.y;
        ...
        public static float GetScrollToCenterPos(this ScrollRect scrollRect, RectTransform target)
        {
            // The scroll rect's view's space is used to calculate scroll position
            var view = scrollRect.viewport != default ? scrollRect.viewport : scrollRect.GetComponent<RectTransform>();
        ...
        public static float GetNormalizedPos(this ScrollRect scrollRect, RectTransform target)
        {
            // The scroll rect's view's space is used to calculate scroll position
            var view = scrollRect.viewport != default ? scrollRect.viewport : scrollRect.GetComponent<RectTransform>();
